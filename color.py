...
class Color(pygame.color.Color):
    ...
    def lighter(self, aditiv_pourcent: float) -> "Color":
    ...
    def lighter_values(self, r: float, g: float, b: float) -> "Color":
    ...
    def darcker(self, soustraciv_pourcent: float) -> "Color":
    ...
    def darcker_values(self, r: float, g: float, b: float) -> "Color":
